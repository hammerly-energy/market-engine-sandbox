...
sign caught here is an afternoon; caught on a bigger network it is an
inexplicable LMP.
...
TestNetworkInvariants holds forever. b_bus stays symmetric and singular on
any network anyone ever hands this repo -- those are properties of the DC
formulation, not of case5.
...
class TestClearingInvariants:
    ...
    Nothing here mentions case5's numbers. They are properties of the
    formulation and hold on whatever network it is handed.
    """
...
class TestBranchValidation:
    ...
    true on any network and any fleet.
    """
